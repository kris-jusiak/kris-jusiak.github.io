    ...
    printf(
      ...
      , '<div class="rounded"><div class="inner">
        ...
        <table>
            ...
            <tr><td style="text-align:right;">US/AU</td><td> | <a href="#resume">View</a></td><td> | <a href="cv/krzysztof_jusiak_resume.pdf">Download</a></td></tr>
        ...
        <hr />
        <iframe id="resume" src="http://docs.google.com/viewer?url=http%3A%2F%2Fkrzysztof-jusiak.github.io%2Fcv%2Fkrzysztof_jusiak_resume.pdf&embedded=true" width="100%" height="100%" style="border: none;"></iframe>
        <hr />
      '.'</div></div>'
      , '</body>'
    );
